    ...
    if ($product['item_id'] == $item_id):
        ...
        <section id="product" class="py-3">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        <img src="<?php echo $product['item_image'] ?>" class="img-fluid" alt=""/>
                    ...
                    <div class="col-sm-6 py-5">
                        <h5 class="font-size-20"><?php echo $product['item_name'] ?></h5>
                        ...
                        <div class="d-flex">
                            ...
                            <a href="#" class="px-2 font-rale font-size-14">20,543 Rating| 1021 Comments</a>
                        ...
                        <table class="my-3">
                            ...
                            <tr class="font-size-14 ">
                                <td>Deal Price</td>
                                <td class="text-danger font-size-20"> $<span> <?php echo $product['item_price'] ?></span><small
                                            class="text-dark font-size-12"> Inclusive all tax</small></td>
                            </tr>
                            <tr class="font-size-14 ">
                                <td>You save</td>
                                <td class="text-danger font-size-20"> $<span> 152</span></td>
                        </table>
                        <div class="policy">
                            <div class="d-flex">
                                <div class="return text-center mr-5">
                                    ...
                                    <a href="#">10 Days return policy</a>
                                </div>
                                <div class="return text-center mr-5">
                                    <div class="font-size-20 my-2 color-second">
                                    ...
                                    <a href="#">Daily tuition</a>
                                </div>
                                <div class="return text-center mr-5">
                                    <div class="font-size-20 my-2 color-second">
                                        <span class="fa fa-check-double border p-3 rounded-pill"></span>
